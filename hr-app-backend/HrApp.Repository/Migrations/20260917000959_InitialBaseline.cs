    ...
    public partial class InitialBaseline : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeDossiers", x => x.DossierID);
                    table.ForeignKey(
                        name: "FK_EmployeeDossiers_Employees_EmployeeID",
                        column: x => x.EmployeeID,
                        principalTable: "Employees",
                        principalColumn: "EmployeeID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneratedDocuments", x => x.DocumentID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeDossiers_EmployeeID",
                table: "EmployeeDossiers",
                column: "EmployeeID",
                unique: true);
